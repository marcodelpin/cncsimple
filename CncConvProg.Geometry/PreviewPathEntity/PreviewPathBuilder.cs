...
namespace CncConvProg.Geometry.PreviewPathEntity
{
    ...
    public class PreviewPathBuilder  // interfaccia 3d solamente per poter essere stampata da controllo view , 
    {
        ...
        /// </summary>
        public void AddLine(EnumPlotStyle enumPlotStyle, double? x, double? y, double? z, double feed)
        {
            /*
             * private 
             */
            ...
            var line = new PreviewLine3D { Start = new Point3D(_lastPoint), End = new Point3D(endpnt), PlotStyle = enumPlotStyle , Feed =  feed};
        ...
        /// </summary>
        public void AddArc(EnumPlotStyle plotStyle, Point3D center, double radius, bool clockWise, double? endX, double? endY, double? endZ, double feed )
        {
            ...
            var arc3D = new PreviewArc3D() { Start = new Point3D(_lastPoint), End = new Point3D(endPoint), Center = center, Radius = radius, ClockWise = clockWise, PlotStyle = plotStyle , Feed = feed};
