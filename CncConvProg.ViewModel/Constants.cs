...
namespace CncConvProg.ViewModel
{
    ...
    {
        public static string EditUserModalDialog = "editusermodaldialog";
        public static string TabellaFilettaturaModalDialog = "TabellaFilettaturaModalDialog";
        public static string MaterialiModalDialog = "MaterialiModalDialog";
